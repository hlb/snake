...
class TestObstacle(SnakeGameTest):
    ...
    def test_dynamic_obstacle_generation(self):
        ...
        danger_positions = {(6, 5), (7, 5), (8, 5),  # Direct front
                          (6, 4), (7, 4), (8, 4),    # Above
                          (6, 6), (7, 6), (8, 6)}    # Below
    ...
    def test_obstacle_render(self):
        ...
        pixel_pos = (test_pos[0] * GRID_SIZE + GRID_SIZE//2,
    ...
    def test_obstacle_generation_edge_cases(self):
        ...
        danger_positions = {(0, GRID_HEIGHT-1), (1, GRID_HEIGHT-1), (2, GRID_HEIGHT-1),  # Front
                          (0, GRID_HEIGHT-2), (1, GRID_HEIGHT-2), (2, GRID_HEIGHT-2),    # Above
                          (0, 0), (1, 0), (2, 0)}                                        # Below (wrapped)
